...
HD_PWD='C:/Users/marwi/Desktop/Code/361/final_project/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digitalClock.vdi -applog -m64 -messageDb vivado.pb -mode batch -source digitalClock.tcl -notrace
