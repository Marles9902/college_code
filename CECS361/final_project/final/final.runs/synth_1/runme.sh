...
HD_PWD='C:/Users/marwi/Desktop/Code/361/final_project/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digitalClock.vds -m64 -mode batch -messageDb vivado.pb -notrace -source digitalClock.tcl
