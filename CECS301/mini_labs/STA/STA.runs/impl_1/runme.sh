...
HD_PWD='C:/Users/marwi/Desktop/Code/301_lab/mini_labs/STA/STA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SD.vdi -applog -m64 -messageDb vivado.pb -mode batch -source SD.tcl -notrace
