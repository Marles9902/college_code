...
HD_PWD='C:/Users/marwi/Desktop/Code/301_lab/mini_labs/STA/STA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SD.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SD.tcl
