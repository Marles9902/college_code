...
// 4-bit 32-element sin wave
const unsigned char SineWave[32] = {8,9,11,12,13,14,14,15,15,15,13,13,14,12,11,9,8,7,5,4,3,2,2,1,1,1,2,2,3,4,5,7};	// x = 4 + 3sin(t)
...
void SysTick_Handler(void){
  ...
  Index = (Index+1)&0x1F;        // 32 samples for each period
	// Index = (Index+1)%16;
	DAC = SineWave[Index]; // output to DAC: 4-bit data
}
