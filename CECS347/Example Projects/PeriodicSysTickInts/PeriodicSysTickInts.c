...
void SysTick_Handler(void){
  GPIO_PORTF_DATA_R ^= 0x04;       // toggle PF2 --> blue
  Counts = Counts + 1; 
}
int main(void){
...
//  SysTick_Init(16000);        // initialize SysTick timer: system clock is 16MHz: t=16000*(1/f)=16000*(1/16000000)=0.001=1ms
  SysTick_Init(1600000*2);        // initialize SysTick timer: system clock is 16MHz: 
	                              // t=1600000*(1/f)=1600000*(1/16000000)=0.1s 
																//[made 0.2s for assignment]
  EnableInterrupts();
