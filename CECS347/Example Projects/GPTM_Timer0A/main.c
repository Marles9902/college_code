...
//  Timer0A_Init(&UserTask, 4000);    // initialize timer2 (20,000 Hz)
//  Timer0A_Init(&UserTask, 5000000); // initialize timer1 (16 Hz)
  Timer0A_Init(&UserTask, 80000000);// initialize timer1 (1 Hz)
//  Timer0A_Init(&UserTask, 0xFFFFFFFF); // initialize timer1 (slowest rate)
  EnableInterrupts();
