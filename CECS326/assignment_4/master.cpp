...
// CECS 326 assignment 4 master.cpp
// terminal input: ./master x my_shm_name sem_name
// description: takes integer for amount of child processes, takes string for name of shared memory and semaphore, forks and executes child processes
...
int main(int argc, char *argv[])
{
    ...
    sem_t *mutex_sem = sem_open(argv[3], O_CREAT | O_RDWR, 0666, 1);
    ...
    // display termination
    cout << "Master remmoved the semaphore" << endl;
